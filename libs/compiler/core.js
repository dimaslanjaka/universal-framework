                    ...
                    sass.render({
                        ...
                        if (!err) {
                            fs.writeFile(outputcss, result.css, function (err) {
                                if (!err) {
                                    log_1.log.log(self.filelog(filename.toString()) + " > " + self.filelog(outputcss) + " " + log_1.log.success("success"));
            ...
            fs.readFile(filejs, {
                ...
                if (!err) {
                    ...
                    fs.writeFile(output, obfuscationResult.getObfuscatedCode(), function (err) {
                        if (!err) {
                            log_1.log.log(self.filelog(filejs) + " > " + self.filelog(output) + " " + log_1.log.success("success"));
                        }
                    });
                }
            });
                                    ...
                                    if (!err) {
                                        if (typeof callback != "function") {
                                            log_1.log.log(log_1.log
                                                .chalk()
                                                .blueBright(self.filelog(file)) + " > " + log_1.log
                                                .chalk()
                                                .blueBright(self.filelog(min)) + " " + log_1.log.chalk().green("success"));
                                        }
                                        else {
