...
function wp_auto_spinner_update_notice() {
		...
		if($version_diff > 0 ){
			?>
			    <div class="error">
			        <p><?php  echo 'Silakan Install Plugin Versi Terakhir ('.$version_current.') title="Download Now »">WP AMT Spinner</a>  <a href="">Download Now »</a>'; ?></p>
			    </div>
		    <?php
...
function wp_auto_spinner_update_version(){
	...
	if(function_exists('curl_init')){
		...
		//curl get
		$x='error';
		$url='http://wpamt.com/versions/wp-auto-spinner.txt';
