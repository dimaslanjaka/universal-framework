	...
	<input type="hidden" value="<?php   echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<!-- Feed part -->
		 ...
		 <!-- Multi-Page Scraper -->
		 		...
		 		<div class="field f_100">
			 		<label>Items list page URL</label> <input value="<?php  echo @$camp_general['cg_ml_source']   ?>" name="cg_ml_source" type="text">	
			 		<div class="description">URL of a page that contains the list of items to post from</div> 
				</div>
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:150px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_ml_lnk_css_rule  ?>" name="cg_ml_lnk_css[]" type="text">
 		 		 				</td>
				...
				<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_ml_lnk_method cg_ml_lnk_method_regex field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:300px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_ml_lnk_regex_rule  ?>" name="cg_ml_lnk_regex[]" type="text">
 		 		 				</td>
				...
				<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_ml_lnk_method cg_ml_lnk_method_visual field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td    style="padding-left:15px;padding-top:8px;" >
 		 		 					 <button  title="Locate"  data-popup-field-name="cg_ml_source" class="visual_selector" >.</button>
 		 		 				</td>
				...
				<div class="field f_100">		 		
			 		<label>Single item content extraction method</label>
					<select class="select_control_div" name="cg_ml_cnt_method">
					
					 	<option value="auto" <?php @wp_automatic_opt_selected('auto',$camp_general['cg_ml_cnt_method']) ?>>Auto detect</option>
					...
					<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_ml_cnt_method cg_ml_cnt_method_css field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:150px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_ml_cnt_css_rule  ?>" name="cg_ml_cnt_css[]" type="text">
 		 		 				</td>
				...
				<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_ml_cnt_method cg_ml_cnt_method_regex field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:300px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_ml_cnt_regex_rule  ?>" name="cg_ml_cnt_regex[]" type="text">
 		 		 				</td>
...
<img src="https://i.imgur.com/YgpMeUW.png"><br>
...
<b>Gob title:</b> [item_title]
<br><b>Company:</b> [item_company]
<br><b>Gob description</b>: [item_description]
