    ...
    public function enqueue()
    {
        ...
        wp_localize_script(
            ...
            [
                ...
                'translations' => [
                    'setup' => esc_html__('What was the dificult part ?', 'kaliforms'),
                    'docs' => esc_html__('What can we describe more ?', 'kaliforms'),
                    'features' => esc_html__('How could we improve ?', 'kaliforms'),
                    'better-plugin' => esc_html__('Can you mention it ?', 'kaliforms'),
                    'incompatibility' => esc_html__('With what plugin or theme is incompatible ?', 'kaliforms'),
                    'maintenance' => esc_html__('Please specify', 'kaliforms'),
                ],
            ]
        );
    }
