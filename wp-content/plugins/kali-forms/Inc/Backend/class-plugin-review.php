...
class Plugin_Review
{
    ...
    {
        $html = '<div id="' . esc_attr($this->slug) . '-review-notice" class="notice notice-success is-dismissible">';
        ...
        $html .= '<a class="' . esc_attr($this->slug) . '-review-button" id="' . esc_attr($this->slug) . '-later" href="#" style="margin-left:10px">' . esc_html($this->messages['later']) . '</a>';
        $html .= '<a class="' . esc_attr($this->slug) . '-review-button" id="' . esc_attr($this->slug) . '-no-rate" href="#" style="margin-left:10px">' . esc_html($this->messages['no_rate']) . '</a>';
        $html .= '</p>';
        $html .= '</div>';
        echo $html;
    }
