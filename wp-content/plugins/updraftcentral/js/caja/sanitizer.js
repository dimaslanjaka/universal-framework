 ...
 * \@namespace
 */
var html_sanitize = (function(html4) {
  ...
  /**
   * Checks for data-* attributes using regex
   * @param (string) attribute name in lowercase
   * @returns (boolean) whether or not attribute name satisfies regex
   */
  function checkRegexAttrib(attribName) {
    var re = /data-\w+/g;
    var key;

    return (re.test(attribName));
  }
...
if ('undefined' !== typeof exports && exports) {
exports.escapeAttrib = html_sanitize.escapeAttrib;
exports.makeHtmlSanitizer = html_sanitize.makeHtmlSanitizer;
exports.makeSaxParser = html_sanitize.makeSaxParser;
exports.makeTagPolicy = html_sanitize.makeTagPolicy;
exports.normalizeRCData = html_sanitize.normalizeRCData;
exports.sanitize = html_sanitize.sanitize;
exports.smartSanitize = function (string, urlX, idX) {
  string = string.replace(/<([a-zA-Z]+)([^>]*)\/>/g, '<$1$2></$1>');
  return html_sanitize.sanitize(string, urlX, idX);
}
exports.sanitizeAttribs = html_sanitize.sanitizeAttribs;
exports.sanitizeWithPolicy = html_sanitize.sanitizeWithPolicy;
exports.unescapeEntities = html_sanitize.unescapeEntities;
}
