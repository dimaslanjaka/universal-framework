...
class Updraft_PHP_Logger extends Updraft_Abstract_Logger {
	...
	public function info($message, array $context = array()) {
		if (defined('WP_DEBUG') && WP_DEBUG) $this->log(Updraft_Log_Levels::INFO, $message, $context);
	}
	...
	public function debug($message, array $context = array()) {
		if (defined('WP_DEBUG') && WP_DEBUG) $this->log(Updraft_Log_Levels::DEBUG, $message, $context);
	}
