...
class Updraft_PHP_Logger extends Updraft_Abstract_Logger {
	...
	public function info($message, array $context = array()) {
		if (defined('WP_DEBUG') && WP_DEBUG) $this->log($message, Updraft_Log_Levels::INFO, $context);
	}
	...
	public function debug($message, array $context = array()) {
		if (defined('WP_DEBUG') && WP_DEBUG) $this->log($message, Updraft_Log_Levels::DEBUG, $context);
	}
