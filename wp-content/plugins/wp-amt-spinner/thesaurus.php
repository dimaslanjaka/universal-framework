    ...
    <div class="metabox-holder columns-2" id="dashboard-widgets">
        <div class="postbox-container" id="postbox-container-1">
            <div class="meta-box-sortables ui-sortable" id="normal-sortables">
                <div class="postbox">
                    <h2 class="hndle"><span>Kamus synonym</span></h2>
                    <div class="inside">
                        <!--  insider start -->
         ...
         <div class="postbox-container" id="postbox-container-2">
            <div class="meta-box-sortables ui-sortable" id="normal-sortables">
                <div class="postbox">
                    <h2 class="hndle"><span>Tambah Kata Synonym Baru</span></h2>
                    <div class="inside">
                        <!--  insider start -->
							<p>Satu Kata Satu Baris</p>
							<textarea  style="width:100%" cols="15" rows="3" class="mceEditor" id="content" name="content"></textarea>
							<button id="add_synonyms" class="button">Kata synonym</button>
                        <!-- /insider 3 -->
                    </div>
                </div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <!--  insider start -->
							...
							<a href="<?php echo site_url('?wp_auto_spinner=backup_synonyms') ?>" class="button">backup synonym</a> 
        ...
        <div class="postbox-container"  >
            <div class="meta-box-sortables ui-sortable" >
                <div class="postbox">
                    <h2 class="hndle"><span>Restore Synonym</span></h2>
                    <div class="inside">
                        <!--  insider start -->
							 
							<p>Opsi ini akan <span style="color:red">menimpa</span> sinonim dengan yang ada di file</p> 
