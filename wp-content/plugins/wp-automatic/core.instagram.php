	...
	foreach ( $keywords as $keyword ) {
		...
		if (trim ( $keyword ) != '') {
			...
			if (count ( $res ) > 0) {
				...
				}elseif( $this->do_tag_exists($camp, array('item_user_profile_pic','item_user_username','item_user_name','item_user_profile_pic','item_location_name','item_location_id','item_location_url')) ){
