...
function wp_automatic_admin_scripts() {
	...
	if( 'wp_automatic' == $post_type ){
		...
		wp_enqueue_style('wp_automatic_basic_styles', plugins_url('css/style.css',__FILE__) ,array() , '1.1.1' ) ;
		...
		wp_enqueue_script('wp_automatic_main_script',plugins_url('js/main.js',__FILE__),array(),'1.9.13');
