...
?>
			...
			<div class="updated">
				<p><?php echo 'Do you mind helping (<a href="http://www.webmanajemen.com/me">Dimas Lanjaka</a>) by rating  "WP AUTO SPINNER plugin" ? your good rating will <strong>help us improve</strong> the plugin <a style="text-decoration: underline;" href="http://www.webmanajemen.com/downloads">Rate Now »</a> <a  style="float:right"  href="' . $uri . '">(x) </a> '; ?></p>
			</div>
<?php
