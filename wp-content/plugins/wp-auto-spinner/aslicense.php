...
function wp_auto_spinner_license_notice()
{
	...
	if (!function_exists('curl_init')) {
		echo '<div class="error"><p>You do not have <a href="http://curl.haxx.se/">Curl library</a> installed. you must install it for "WP AUTO SPINNER" plugin to function.  </p></div>';
		return;
	}
