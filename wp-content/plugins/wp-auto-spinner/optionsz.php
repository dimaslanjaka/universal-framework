...
{ ?>
	...
	<div class="wrap">
		...
		<h2>WP AUTO SPINNER Settings</h2>
		<!--before  container-->
										...
										<div class="option clearfix">
											...
											<span class="option-title">
												Also automatically spin articles I manually write <p>
													<i>(this will spin posts you are writing manually so when you write and preview post it will get spinned instantly)(not recommended)</i> .
												</p>
											</span>
										</div>
		...
		<div style="width:49%;" class="postbox-container">
			<div style="min-height:1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
				...
				<div id="categorydiv" class="postbox " style="margin-top:20px">
					...
					<h3 class="hndle"><span>Exclude these categories from auto spinning</span></h3>
					<div class="inside">
	...
	<div class="metabox-holder" id="dashboard-widgets">
		<div style="width:49%;" class="postbox-container">
			<div style="min-height:1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
				...
				<div id="categorydiv" class="postbox " style="margin-top:20px">
					<div class="handlediv" title="Click to toggle"><br></div>
					<h3 class="hndle"><span>Reserved words </span></h3>
					<div class="inside">
						<div id="taxonomy-category" class="categorydiv">
