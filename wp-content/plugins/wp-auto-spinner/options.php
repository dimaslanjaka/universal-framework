												...
												<tr>
													...
													<td>
														<select name="wp_auto_spinner_lang" id="field1zz">
															...
															<option disabled value="id" <?php opt_selected('id', $wp_auto_spinner_lang) ?>>Indonesian</option>
															...
															<option disabled value="id4" <?php opt_selected('id4', $wp_auto_spinner_lang) ?>>Indonesian 4</option>
														</select>
