...
$udaddons2_mothership = (defined('UPDRAFTPLUS_ADDONS_TESTING') && UPDRAFTPLUS_ADDONS_TESTING && isset($_SERVER['SERVER_NAME']) && 'localhost' == $_SERVER['SERVER_NAME']) ? 'http://localhost/ud' : $udaddons2_mothership;
...
class UpdraftPlusAddons2 {
	 ...
	 *
	 * @return Array - as returned by wp_remote_post()
	 */
	...
	public function connection_status() {
		...
		if (true !== $this->debug && !isset($_GET['udm_refresh']) && is_array($trans)) {
