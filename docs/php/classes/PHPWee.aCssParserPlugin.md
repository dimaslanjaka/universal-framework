...
# Abstract Class: \PHPWee\aCssParserPlugin
...
* [public getTriggerChars()](../classes/PHPWee.aCssParserPlugin.md#method_getTriggerChars)
* [public getTriggerStates()](../classes/PHPWee.aCssParserPlugin.md#method_getTriggerStates)
* [public parse()](../classes/PHPWee.aCssParserPlugin.md#method_parse)
---
### Details
* File: [phpwee\src\CssMin\CssMin.php](../files/phpwee.src.CssMin.CssMin.md)
* Package: Default
* Class Hierarchy:
  * \PHPWee\aCssParserPlugin
* See Also:
...
```
Abstract public getTriggerChars() : array
```
...
```
Abstract public getTriggerStates() : array
```
...
```
Abstract public parse(integer  $index, string  $char, string  $previousChar,   $state) : mixed
```
