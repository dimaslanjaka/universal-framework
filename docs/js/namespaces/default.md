...
| [\SmartDOMDocument](../classes/SmartDOMDocument.md) | This class overcomes a few common annoyances with the DOMDocument class,
...
<a name="constant_DB_HOST" class="anchor"></a>
###### DB_HOST
```
...
<a name="constant_MYSQL_CLIENT_SSL" class="anchor"></a>
###### MYSQL_CLIENT_SSL
```
...
<a name="method_array_unique_recursive" class="anchor"></a>
...
<a name="method_determine_user" class="anchor"></a>
####  determine_user() 
...
```
 innerHTML(\DOMNode  $element) : string
```
...
```
 mysql_real_escape_string(  $unescapedString, \mysqli  $link = null) 
```
...
<a name="method_resolve_file" class="anchor"></a>
####  resolve_file() : string
...
<a name="method_strposa" class="anchor"></a>
####  strposa() 

```
 strposa(  $haystack,   $needles = array(),   $offset) 
```
...
<a name="method_sys_getloadavg" class="anchor"></a>
####  sys_getloadavg() 
...
**Details:**
* File: [AGC\loader\dimas.sys.php](../files/AGC.loader.dimas.sys.md)
...
<a name="method_toNumber" class="anchor"></a>
####  toNumber() : integer&amp;#124;float&amp;#124;null

```
 toNumber(integer&amp;#124;float&amp;#124;string  $val) : integer&amp;#124;float&amp;#124;null
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code>integer&#124;float&#124;string</code> | $val  |  |

**Returns:** integer&#124;float&#124;null
...
<a name="method_UA" class="anchor"></a>
####  UA() 
...
<a name="method_uid" class="anchor"></a>
####  uid() 

```
 uid(integer  $length = 5) 
```
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code>integer</code> | $length  | default 5 |
...
<a name="method_url_parser" class="anchor"></a>
####  url_parser() 
...
<a name="method_USER_IP" class="anchor"></a>
####  USER_IP() 
...
<a name="method_vd" class="anchor"></a>
####  vd() : void
...
```
 write(string  $file, string  $content,   $append = false) : void
```
