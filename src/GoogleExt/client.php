...
class client extends Google_Client
{
   ...
   * @return client
   */
  public function setCredentials($client, $secret, $key)
  {
   ...
   * @return string
   */
  public function getOrigin($path = null)
  {
  ...
  public function set_token_folder($path)
  {
   ...
   */
  public function check_subscriber($cid = 'UCGNaoefvJRfd15fo-LQ0zvg', $only_get_url = false)
  {
    if (!$only_get_url) {
      /**
       * @var Google_Client
