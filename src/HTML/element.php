...
class element
{
    ...
    public function direct($element, $content, array $attr = [])
    {
    ...
    public function create($element, $content = '', array $attributes = [], array $options = ['formatOutput' => false])
    {
        if ('select' == $element) {
    ...
    public function single_create($element, $content = '', array $attributes = [])
    {
        if (empty($attributes) && is_array($content)) {
            $attributes = $content;
            $content = '';
