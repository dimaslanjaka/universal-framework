...
class session
{
   ...
   * Is session set ?
   */
  public static function has($key, $empty = true)
  {
  ...
  private function configure($timeout, $folder = null)
  {
  ...
  private function protect_session($timeout)
  {
   ...
   */
  private function regenerate($destroy = false)
  {
