    ...
    <ul class="custom-scrollbar">
        ...
        <li>
            <ul class="collapsible collapsible-accordion">
                ...
                <li><a class="collapsible-header waves-effect arrow-r"><img src="/assets/img/telkomsel.png"
                                                                            alt="telkomsel panel" width="20px"
                                                                            height="20px" class="p-0 m-0"><i
                                class="fas fa-angle-down rotate-icon"></i></a>
                    <div class="collapsible-body">
                        <ul>
                ...
                <li><a class="collapsible-header waves-effect arrow-r"><img src="/assets/img/im3.png"
                                                                            alt="telkomsel panel" width="20px"
                                                                            height="20px" class="p-0 m-0"><i
                                class="fas fa-angle-down rotate-icon"></i></a>
                    <div class="collapsible-body">
                ...
                <li><a class="collapsible-header waves-effect arrow-r"><i class="sv-slim-icon fal fa-toolbox"></i><i
                                class="fas fa-angle-down rotate-icon"></i></a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="/tools/json-viewer" alt="JSON viewer Online" class="waves-effect">
                                    <span class="sv-slim"> <img src="/assets/img/json.png" alt="telkomsel panel"
                                                                width="20px" height="20px" class="p-0 m-0"> </span>
                                    <span class="sv-normal">JSON Viewer Online</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="d-none"><a id="toggle" class="waves-effect"><i
                                class="sv-slim-icon fas fa-angle-double-right"></i>Minimize menu</a>
                </li>
            </ul>
        </li>
        <!--/. Side navigation links -->
