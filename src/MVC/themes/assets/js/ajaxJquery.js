...
var ajaxIDLoader = "ajxLoader_" + Math.random().toString(36).substring(2) + Date.now().toString(36);
...
$(document).ajaxSuccess(function (event, request, settings) {
    ...
    if (typeof res == 'object' && !settings.hasOwnProperty('silent') && typeof toastr != 'undefined') {
...
//# sourceMappingURL=ajaxJQuery.js.map