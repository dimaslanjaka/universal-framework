                ...
                <div class="tab-pane fade show active  h-100" id="firstFull" role="tabpanel" aria-labelledby="first-tab">
                    ...
                    <div class="scroll">
                        ...
                        <?php foreach ($data['users'] as $user) {
                            if ($_SESSION['user']['nama'] == $user['nama']) {
                                continue;
                            }
                            //var_dump($user);
                        ?>
                            <div class="d-flex flex-row mb-1 border-bottom pb-3 mb-3">
                                ...
                                <a class="d-flex" href="#">
                                    <!--<img alt="Profile Picture" src="<?= BASEURL; ?>img/profiles/l-3.jpg" class="img-thumbnail border-0 rounded-circle mr-3 list-thumbnail align-self-center xsmall" id="profile-image-<?= $user['nama'] ?>">-->
                                    <div id="profileImage-<?= $user['nama'] ?>" data-name="<?= $user['nama'] ?>"></div>
                                </a>
