...
### <span style="display: none;">\Cookie\helper</span> Constants
> This class has not constants.

### <span style="display: none;">\Cookie\helper</span> Methods
  
:::tip <a id="Cookie-helper::__call" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> __call ( )   
-----
...
:::tip <a id="Cookie-helper::all" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> all ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::day" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> day ( )  <Badge text="static" type="warn"/>  
-----
...
| `$expire` | **`mixed`** |  |
| `$path` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$domain` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$secure` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$httponly` <Badge text="optional" type="warn"/>| **`mixed`** |  |


| | |
|:--------:| ----------- |
| **See also** |`\Cookie\helper::set()` <br /> automatically set expire time to day format <br /> |
...
:::tip <a id="Cookie-helper::del" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> del ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::destroy" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> destroy ( )  <Badge text="static" type="warn"/>  
-----

Destroy all cookies except php session and spesific cookies name.

```php
public static function destroy( array $except = array() ) : void
```

| Parameter | Type(s) | Description |
|-----------|------|-------------|
| `$except` <Badge text="optional" type="warn"/>| **`array`** |  |
...
:::tip <a id="Cookie-helper::domain" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> domain ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::get" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> get ( )  <Badge text="static" type="warn"/>  
-----
...
|-----------|------|-------------|
| `$name` | **`mixed`** |  |
| `$AllowEmpty` <Badge text="optional" type="warn"/>| **`mixed`** |  |
...
:::tip <a id="Cookie-helper::get_current_path" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> get_current_path ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::get_current_url" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> get_current_url ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::has" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> has ( )  <Badge text="static" type="warn"/>  
-----
...
|-----------|------|-------------|
| `$name` | **`mixed`** |  |
| `$AllowEmpty` <Badge text="optional" type="warn"/>| **`boolean`** | if true, will return false if cookie value empty |
...
:::tip <a id="Cookie-helper::hours" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> hours ( )  <Badge text="static" type="warn"/>  
-----
...
| `$name` | **`mixed`** |  |
| `$value` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$expire` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$path` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$domain` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$secure` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$httponly` <Badge text="optional" type="warn"/>| **`mixed`** |  |
...
| | |
|:--------:| ----------- |
| **See also** |`\Cookie\helper::set()` <br /> automatically set expire time to hours format <br /> |
...
:::tip <a id="Cookie-helper::mins" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> mins ( )  <Badge text="static" type="warn"/>  
-----
...
| | |
|:--------:| ----------- |
| **See also** |`\Cookie\helper::set()` <br /> automatically set expire time to minutes format <br /> |
...
:::tip <a id="Cookie-helper::one" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> one ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::reconstruct_url" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> reconstruct_url ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::secure" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> secure ( )  <Badge text="static" type="warn"/>  
-----
...
:::tip <a id="Cookie-helper::set" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> set ( )  <Badge text="static" type="warn"/>  
-----
...
| `$name` | **`mixed`** |  |
| `$value` | **`mixed`** |  |
| `$expire` | **`float`** <br /> **`integer`** <br /> **`string`** | 1m/1h/1d/1y |
| `$path` <Badge text="optional" type="warn"/>| **`mixed`** |  |
| `$domain` <Badge text="optional" type="warn"/>| **`string`** | default $_SERVER['HTTP_HOST'] |
...
#### <span style="display: none;">\Cookie\helper</span> Inherited methods
> This class has not inherited methods.

### <span style="display: none;">\Cookie\helper</span> Properties
...
#### <span style="display: none;">\Cookie\helper</span> Inherited properties
...
:::tip <a id="GoogleExt-recaptcha::verify" style="display: block; position: relative; top: -5rem; visibility: hidden;"></a> verify ( )   
-----
