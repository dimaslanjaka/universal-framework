  ...
  <div class="card">
    <div class="card-body">
      ...
      <form action="roles" method="post" id="access-management">
            ...
            <div class="col-sm-10">
              <div class="md-form" id="group-<?= $key ?>" data-key="<?= $key ?>">
                ...
                foreach ($value as $path) {
                  ...
                  echo '<div class="row"><div class="col"><select data-key="' . $path . '" id="Access-' . md5($key . $path) . '" class="select2"><option></option></select></div><div class="col-md-2 p-0 m-0"><button class="btn btn-danger" role="button" type="button"><i class="fad fa-trash"></i></button></div></div>';
                }
        ...
        <div class="form-row">
          <div class="col-md-3">
            <button type="button" class="btn btn-success btn-block"><i class="fad fa-plus"></i></button>
          </div>
          <div class="col">
