<div>
  <form action="/server/comments/submit" method="post" enctype="application/json" id="comment_submission">
    <input type="hidden" name="comment[submit]">
    <input type="hidden" name="comment[page]" value="<?= \MVC\helper::get_canonical(null, false) ?>">
...
<?php
define('stylesrc', \MVC\helper::get_url_path(__DIR__ . '/index.css', true));
