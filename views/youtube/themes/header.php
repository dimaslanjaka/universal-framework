...
<head>
  ...
  <meta name="twitter:title"
    content="<?= (isset($site_title) ? $site_title : (get_option('yt-site-title') ? get_option('yt-site-title') : $id)); ?>">
  <meta name="twitter:description"
    content="<?= (isset($site_desc) ? $site_desc : 'Youtube Downloader'); ?>">
  <meta name="twitter:image"
    content="<?= (isset($site_img) ? $site_img : 'https://themepixels.me/azia/img/azia-social.png'); ?>">

  <!-- Facebook -->
  <meta property="og:url"
    content="<?= (isset($_SERVER['HTTPS']) && 'on' === $_SERVER['HTTPS'] ? 'https' : 'http') . "://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}"; ?>">
  <meta property="og:title"
    content="<?= (isset($site_title) ? $site_title : 'Youtube Downloader'); ?>">
  ...
  <link rel="icon" type="image/png" sizes="64x64"
    href="<?= (isset($site_img) ? $site_img : 'https://themepixels.me/azia/img/azia-social.png'); ?>">
  <!-- Apple/Safari icon -->
  ...
  <title><?= trim((isset($site_title) ? "Download $site_title Mp3" : 'Youtube Downloader') . (get_option('yt-site-title') ? ' | ' . get_option('yt-site-title') : '')); ?></title>
