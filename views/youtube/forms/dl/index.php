...
$my_video_info = 'https://www.youtube.com/get_video_info?&video_id=' . $my_id . '&asv=3&el=detailpage&hl=en_US'; //video details fix *1
$output['url'] = $my_video_info;
$my_video_info = curlGet($my_video_info);
//var_dump($my_video_info);
...
for ($i = 0; $i < count($avail_formats); ++$i) {
  ...
  $my_vid['Download'][$i]['type'] = $avail_formats[$i]['type'];
...
$core->dump(['data' => $my_vid, 'output' => $output]);
