...
public class cipher {
    public static void main(String[] args){
        try {
            CryptLib _crypt = new cipher();
            String test = "eyJjdCI6InhrQm1mSFpnb1lQSmpQcXVzXC9nM24xWFQ0V0pYT1FKTGVxT1wvQ3pmNDFzWT0iLCJpdiI6IjRiZDIzZGQzMDA2NzMxZTM0OTJkNjBjZDMzNDEyM2Q3IiwicyI6IjJiZThhN2U1NTM5MTBkMzMifQ==";
            String key = "BlVssQKxzAapotek.io";
            String iv = generateRandomIV(16); //16 bytes = 128 bit
            System.out.println(_crypt.decrypt(test, key,iv));
        } catch(Exception e){
	...
	public cipher() throws NoSuchAlgorithmException, NoSuchPaddingException {
