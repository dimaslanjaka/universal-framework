<div class="container register">
  <div class="row">
    <div class="col-md-3 register-left">
      ...
      <form action="/shortlink/login" method="get">
    ...
    <div class="col-md-9 register-right">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          <h3 class="register-heading">Register Customized Shortlink</h3>
          <div class="row register-form">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <input type="password" name="pwd2" class="form-control" placeholder="Confirm Password *" value="" />
              </div>
              <div class="form-group">
                <div class="maxl">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <input type="text" minlength="5" maxlength="13" name="phone" class="form-control"
