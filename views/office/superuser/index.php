<div class="container">
  ...
  <div class="card-deck">
    <div class="card">
      ...
      <img class="card-img-top img-fluid" src="https://dummyimage.com/400x200/563d7c/ffffff&text=.card-img-topfff&text=List" alt="Card image cap" width="400">
      <div class="card-body">
        <h4 class="card-title">List</h4>
        <p class="card-text">Inventory Lists</p>
      </div>
      <div class="card-footer">
        <a href="list" class="btn btn-round rand-bg-color"><i class="fad fa-arrow-right"></i></a>
      </div>
    </div>
