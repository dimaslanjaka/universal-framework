  ...
  columns: [
    ...
    { data: "telp", title: "Telephone" },
    {
      ...
      render: function (data) {
        return `<div class="btn-group"><a href="/distributor/edit?id=${data}" class="btn btn-sm"><i class="fas fa-pen"></i></a><a class="btn btn-sm" id="delete-distributor-${data}" data-id="${data}" title="Disable" disabled><i class="fas fa-ban"></i></a></div>`;
      },
      title: "Actions",
    },
  ],
