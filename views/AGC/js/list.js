...
$('[data-controller]').click(function (e) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (!$(response).filter('input#target_translator').length){
        return swal({
          title: 'major translator not found',
          content: {
            element: 'p',
            attributes: {
              innerHTML: 'Please <a href="//web-manajemen.blogspot.com/p/contact.html">Contact Admin</a>'
            }
          }
        })
      }
