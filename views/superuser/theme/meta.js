        ...
        function(v, i) {
          ...
          for (const key in v.data) {
            if (v.data.hasOwnProperty(key)) {
              ...
              v[key] = `<form action="" method='post'><input type="hidden" name="path" value="${v.path}" /><input type="hidden" name="config" value="${v.path}" /><div class='md-form'><input type="${typeInput}" name='${key}' value='${v.data[key]}' /></div></form>`;
            }
          }
          //console.log(v);
        });
